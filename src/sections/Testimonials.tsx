    ...
    <div className="container">
      <div className="section-heading">
        ...
        <p className="section-description mt-5">
          Using this platform has completely transformed the way I work. The intuitive design and powerful features have helped me stay organized and on top of my tasks. I can&apos;t imagine going back to the old way of doing things!
        </p>
      </div>
